...
class Evaluation(object):
    ...
    def sample(self, n_samples: int, input_length: int, n_classes: int, kind: str, class_index: int = -1, path_root: str = ''):
        ...
        try:
            ckpt_fname = os.path.join(path_root, 'saved_models', fname)
