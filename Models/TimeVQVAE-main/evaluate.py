...
def train_stage2_eva(config: dict,
                 dataset_name: str,
    ...
    wandb_logger = DummyLogger()#WandbLogger(project='TimeVQVAE-stage2', name=None, config=config_)
...
if __name__ == '__main__':
    ...
    for dataset_name in dataset_names:
        ...
        # train
        train_stage2_eva(config, dataset_name, train_data_loader, args.gpu_device_idx)
